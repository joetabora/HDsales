...
export function AppHeader({ user }: AppHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-16 items-center gap-4 border-b border-forge-border bg-forge-background/80 backdrop-blur-xl px-6">
      <Button
        variant="outline"
      ...
      >
        ...
        <span className="text-sm">Search customers, inventory, tasks…</span>
      ...
      <div className="flex items-center gap-2">
        <Button variant="ghost" size="icon" className="relative text-forge-muted-foreground">
          <Bell className="h-5 w-5" />
          <span className="absolute top-2 right-2 h-2 w-2 rounded-full bg-forge-accent ring-2 ring-forge-background" />
        </Button>
